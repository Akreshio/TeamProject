...
public class RateCurrencyChangingImplTest {
    ...
    @Test
    void testGetTimePeriodWithoutParams() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        List<LocalDateTime> resultTest = getLastTenDays();
    ...
    void testGetTimePeriodHour() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        List<LocalDateTime> resultTest = new ArrayList<>();
        resultTest.add(date);
        resultTest.add(date.plusDays(5));
    ...
    void testGetTimePeriodDay() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        List<LocalDateTime> resultTest = new ArrayList<>();
        resultTest.add(date);
        resultTest.add(date.plusDays(1));
        resultTest.add(date.plusDays(2));
    ...
    void testGetTimePeriodWeek() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        List<LocalDateTime> resultTest = new ArrayList<>();
        resultTest.add(date);
        resultTest.add(date.plusDays(7));
        resultTest.add(date.plusDays(14));
        resultTest.add(date.plusDays(21));
    ...
    void testGetTimePeriodMonth() throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
        ...
        List<LocalDateTime> resultTest = new ArrayList<>();
        resultTest.add(date);
        resultTest.add(date.plusMonths(1));
        resultTest.add(date.plusMonths(2));
